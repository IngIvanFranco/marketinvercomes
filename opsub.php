...
<article id="products" class="contenedorproductos">
   ...
   $empieza = ($pagina-1) * $por_pagina;
        ...
        WHERE  id_opc_subcate = $q  AND status = '1'
...
echo "<a href='opsub.php?q=$q&pagina=1' class='pagesq'>"."<i class='icon-left'></i>"."</a>";

for($i=1; $i<=$total_paginas; $i++){
   echo "<a href='opsub.php?q=$q&pagina=".$i."' class='numpage'>".$i."</a>";
}

echo "<a href='opsub.php?q=$q&pagina=$total_paginas' class='pagesq'>"."<i class='icon-right'></i>"."</a>";
